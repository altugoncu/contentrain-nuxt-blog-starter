<template>
  <header>
    <div v-if="headerData" class="w-full flex justify-center items-center py-4">
      <div class="logo-container">
        <nuxt-link to="/">
          <img class="w-48 h-auto" :src="headerData.logo.split('public')[1]" alt="App Icon" />
        </nuxt-link>
      </div>
    </div>
    <div v-if="headerData" class="w-full flex justify-center items-center py-4">
      <div class="label-container">
        <nuxt-link to="/">
          <img class="w-48 h-auto" :src="headerData.label.split('public')[1]" alt="App Icon" />
        </nuxt-link>
      </div>
    </div>
    <div class="w-full justify-around social-links text-2xl flex items-center">
      ...
      <a v-for="(link, i) in headerData.socialIcons" :key="i" :href="link.url" target="_blank" rel="noopener noreferrer"
        ...
        <i :class="link.iconName" class="text-gray-800 ml-1"></i></a>
    </div>
  </header>
</template>
